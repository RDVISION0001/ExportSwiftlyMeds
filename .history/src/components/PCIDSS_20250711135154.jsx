...
const PciDssCompliance = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-[#b0f4ff4e] to-white">
            ...
            >
                <motion.div
                    ...
                    className="inline-flex items-center justify-center bg-teal-100 rounded-full p-4 mb-6"
                >
                ...
                <motion.p
                    ...
                    className="text-sm md:text-xl text-teal-100 max-w-3xl mx-auto"
                >
            ...
            >
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="mt-16 bg-teal-600 rounded-xl p-8 text-center text-white"
                >
                    <h2 className="text-xl md:text-3xl font-bold mb-4">Need More Details?</h2>
                    <p className="text-teal-100 mb-6 max-w-2xl mx-auto text-sm md:text-[15px]">
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="bg-white text-teal-600 font-semibold px-6 py-3 rounded-lg hover:bg-teal-50 transition-colors duration-300"
                    >
