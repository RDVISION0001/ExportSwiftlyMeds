    ...
    return (
        <div ref={topRef} className='bg-white w-full py-8'>
            <div className="flex flex-col md:flex-row gap-6 max-w-8xl mx-auto px-4 md:px-10 lg:px-20">
                ...
                <div className={`${showMobileSidebar ? 'block' : 'hidden'} md:block w-full md:w-1/4 bg-white md:bg-transparent z-20 md:z-0 fixed md:static inset-0 overflow-y-auto md:overflow-y-visible`}>
                ...
                {/* Main Content - Takes 75% width on desktop */}
