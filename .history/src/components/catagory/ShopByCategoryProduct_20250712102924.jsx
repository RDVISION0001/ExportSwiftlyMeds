...
import { IoSearchOutline, IoArrowForward, IoMenu, IoClose } from "react-icons/io5";
...
const ShopByCategoryProduct = () => {
    ...
    const toggleCategory = (categoryId) => {
        ...
        setCatId(categoryId);
        // Close mobile sidebar after selection if on mobile
    ...
    return (
        <div ref={topRef} className='bg-white w-full py-8'>
            <div className="flex flex-col md:flex-row gap-6 max-w-8xl mx-auto px-4 md:10 lg:px-20">
                ...
                <div className={`${showMobileSidebar ? 'block' : 'hidden'} md:block w-full md:max-w-3xl md:flex-shrink-0 bg-white md:bg-transparent z-20 md:z-0 fixed md:static inset-0 overflow-y-auto md:overflow-y-visible`}>
                    <div className="p-4 md:p-0 bg-white h-full md:h-auto">
