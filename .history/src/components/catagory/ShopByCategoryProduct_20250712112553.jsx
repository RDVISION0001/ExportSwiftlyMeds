...
const ShopByCategoryProduct = () => {
    ...
    const itemsPerPage = 20; // Fixed at 10 items per page
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center p-4 border-t border-gray-200">
                ...
                <div className="flex items-center gap-2">
                    <button
                        ...
                        className={`p-2 rounded-full cursor-pointer border ${currentPage === 1 ? 'text-gray-400 cursor-not-allowed' : 'text-teal-600 hover:bg-teal-50'}`}
                    >
                    ...
                    <button
                        ...
                        className={`p-2 rounded-full cursor-pointer border ${currentPage === totalPages ? 'text-gray-400 cursor-not-allowed' : 'text-teal-600 hover:bg-teal-50'}`}
                    >
    ...
    return (
        <div ref={topRef} className='bg-white w-full py-8'>
            <div className="flex flex-col md:flex-row gap-6 max-w-8xl mx-auto px-4 md:px-10 lg:px-20">
                ...
                <div 
                    className={`${showMobileSidebar ? 'block' : 'hidden'} md:block w-full md:w-[20%] bg-white z-20 md:z-0 fixed md:sticky top-0 h-screen overflow-y-hidden border border-gray-100 rounded-lg `}
                >
