        ...
        if (startPage > 1) {
            pages.push(
                <button
                    ...
                    className={`px-3 py-1 rounded ${1 === currentPage ? 'bg-teal-600 text-white' : 'bg-white text-teal-600 border border-teal-600'}`}
                >
                    1
                </button>
            );
        ...
        for (let i = startPage; i <= endPage; i++) {
            pages.push(
                <button
                    ...
                    className={`px-3 py-1 rounded ${i === currentPage ? 'bg-teal-600 text-white' : 'bg-white text-teal-600 border border-teal-600'}`}
                >
                    {i}
                </button>
            );
        ...
        if (endPage < totalPages) {
            ...
            pages.push(
                <button
                    ...
                    className={`px-3 py-1 rounded ${totalPages === currentPage ? 'bg-teal-600 text-white' : 'bg-white text-teal-600 border border-teal-600'}`}
                >
                    {totalPages}
                </button>
            );
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center p-4 border-t border-gray-200">
                    ...
                    <div className="flex items-center gap-1">
                        <button
                            ...
                            className={`p-2 rounded ${currentPage === 1 ? 'text-gray-400 cursor-not-allowed' : 'text-teal-600 hover:bg-teal-50'}`}
                        >
                        ...
                        <button
                            ...
                            className={`p-2 rounded ${currentPage === totalPages ? 'text-gray-400 cursor-not-allowed' : 'text-teal-600 hover:bg-teal-50'}`}
                        >
    ...
    return (
        <div ref={topRef} className='bg-white w-full py-8'>
            <div className="flex flex-col md:flex-row gap-6 max-w-8xl mx-auto px-4 md:px-10 lg:px-20">
                ...
                <div
                    className={`${showMobileSidebar ? 'block' : 'hidden'} md:block w-full md:w-1/4 bg-white z-20 md:z-0 fixed md:sticky top-0 h-screen overflow-y-hidden`}
                >
