            ...
            <div className="flex flex-col sm:flex-row justify-between items-center p-4 border-t border-gray-200">
                ...
                <div className="flex items-center gap-2">
                    <button
                        ...
                        className={`p-2 rounded-full cursor-pointer ${currentPage === 1 ? 'text-gray-400 cursor-not-allowed' : 'text-teal-600 hover:bg-teal-50'}`}
                    >
                    ...
                    <button
                        ...
                        className={`p-2 rounded-full cursor-pointer ${currentPage === totalPages ? 'text-gray-400 cursor-not-allowed' : 'text-teal-600 hover:bg-teal-50'}`}
                    >
