    ...
    const benefits = [
        {
            ...
            description: "Get your medicine delivered to the desired destination  timely and safely.", //change by manager sir
            icon: (
        ...
        },
        {
            ...
            description: "Our expert customer support team is available 24x7 for quick response.", //change by manager sir
            icon: (
                <svg className="w-12 h-12" viewBox="0 0 24 24" fill="currentColor">
        ...
        },
        {
            ...
            description: "We care not only about the quality of drugs, but also about the quality of customer service.",
            icon: (
                <svg className="w-12 h-12" viewBox="0 0 24 24" fill="currentColor">
