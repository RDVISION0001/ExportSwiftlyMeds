        ...
        <>
            ...
            <div className="bg-gray-100 min-h-screen font-sans mt-10">
                <div className='w-[95%] mx-auto flex flex-col lg:flex-row justify-center items-start gap-2'>
                    {/* Main Product Content - Mobile first full width, then 75% on larger screens */}
                    <div className='w-full lg:w-[75%] border border-gray-300 rounded-md my-2 lg:h-screen lg:overflow-y-auto hide-scrollbar'>
                        <div className="mx-auto p-4 sm:px-6 lg:px-8">
                            {/* Product Gallery - Stack on mobile, side by side on larger screens */}
                            <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 flex flex-col lg:flex-row w-full mb-1">
                                {product && (
                                    <div className="flex flex-col items-center w-full lg:w-[45%] mb-6 lg:mb-0">
                                        <div className="w-full h-64 sm:h-80 rounded-lg flex items-center justify-center overflow-hidden">
                                ...
                                {/* Product Info - Full width on mobile, 75% on larger screens */}
                                    ...
                                    <div className="mb-6 sm:mb-8">
                                        ...
                                        <div className="bg-yellow-50 border-l-4 border-yellow-500 p-3 sm:p-4 mb-4 sm:mb-6 rounded-r-lg shadow-sm">
                                            <div className="flex items-start">
                                                <svg className="h-5 w-5 sm:h-6 sm:w-6 text-yellow-500 mr-2 sm:mr-3" fill="currentColor" viewBox="0 0 20 20">
                                                    <path
                                                        fillRule="evenodd"
                                                ...
                                                <div className="flex items-start mb-3">
                                                    ...
                                                    {product && (
                                                        <div>
                                                            ...
                                                            <p className="mt-1 text-gray-900 text-sm sm:text-base">{product.strength || 'Not specified'}</p>
                                                        </div>
                                                    )}
                                                </div>
                                                ...
                                                <div className="flex items-start">
                                                    ...
                                                    {product && (
                                                        <div>
                                                            ...
                                                            <p className="mt-1 text-gray-900 text-sm sm:text-base">{product.packagingType || 'Not specified'}</p>
                                                        </div>
                                                    )}
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                <div className="flex items-start mb-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="mt-1 text-gray-900 text-sm sm:text-base">{product?.composition || 'Not specified'}</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="flex items-start">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="mt-1 text-gray-900 text-sm sm:text-base">{product?.usedFor || 'Not specified'}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            {/* Pricing Table - Responsive with horizontal scroll on small screens */}
                            ...
                            <div className="bg-gray-50 rounded-xl p-4 sm:p-8 shadow-sm">
                                ...
                                <p className="text-gray-700 text-sm sm:text-base leading-relaxed">{product?.description || 'No disclaimer information available.'}</p>
                            </div>
                        </div>
                    </div>

                    {/* Cart Section - Full width on mobile, 25% on larger screens */}
