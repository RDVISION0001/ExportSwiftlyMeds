      ...
      <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-white rounded-md">
              ...
              <p className="mt-2 text-gray-700 font-medium">
                Email: cancellations@swiftlymeds.com<br />
        ...
        <section className="bg-blue-50 rounded-lg p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-white rounded-md">
              ...
              <p className="mt-2 text-gray-700 font-medium">
                Email: <a href="mailto:info@mensvitaminshop.com" className="hover:underline text-gray-600 hover:text-gray-800">info@SwiftlyMeds.com</a><br />
        ...
        <section className="bg-blue-50 rounded-lg p-6">
          ...
          <p className="text-gray-700">
            We may update this policy periodically. The current version is always available on our website and was last updated on [Insert Date].
          </p>
        </section>
